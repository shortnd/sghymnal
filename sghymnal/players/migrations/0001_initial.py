    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', sorl.thumbnail.fields.ImageField(blank=True, upload_to=sghymnal.players.models.thumnail_upload_path, verbose_name='Player Thumbnail')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bios', to='players.Player')),
            ],
        ),
    ]
